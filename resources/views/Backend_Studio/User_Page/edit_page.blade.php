...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('overall.update') }}" class="forms-sample" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digimon_name" value="{{ $digimonEdit->digimon_name }}" placeholder="Digimon Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showImage" src="{{ (!empty($digimonEdit->digimon_logo)) ? url('Images/Logo/'.$digimonEdit->digimon_logo) : url('Images/admin.png') }}" alt="digimon logo" width="200" height="150" class="mb-2">
