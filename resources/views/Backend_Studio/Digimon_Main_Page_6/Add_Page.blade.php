...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimonxroswars.store') }}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="teamlogo_name" placeholder="Team Logo Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showTeamlogoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros1_evo_name" placeholder="Xros 1 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros1EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros2_evo_name" placeholder="Xros 2 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros2EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros3_evo_name" placeholder="Xros 3 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros3EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros4_evo_name" placeholder="Xros 4 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros4EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros5_evo_name" placeholder="Xros 5 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros5EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros6_evo_name" placeholder="Xros 6 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros6EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="xros7_evo_name" placeholder="Xros 7 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showXros7EvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
