...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimon02.update') }}" class="forms-sample" enctype="multipart/form-data">
                  @csrf

                  <input type="hidden" name="id" value="{{ $digimon02Edit->id }}">

                    <!--Character Preview-->
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="character_name" value="{{ $digimon02Edit->character_name }}" placeholder="Character Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showCharacterImage" src="{{ (!empty($digimon02Edit->character_img)) ? url('Images/Digimon_02/'.$digimon02Edit->character_img) : url('Images/admin.png') }}" width="150" height="250" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digivise_name" value="{{ $digimon02Edit->digivise_name }}" placeholder="Digivise Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDigiviseImage" src="{{ (!empty($digimon02Edit->digivise_img)) ? url('Images/Digimon_02/'.$digimon02Edit->digivise_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="armoregg1_name" value="{{ $digimon02Edit->armoregg1_name }}" placeholder="Armor Egg 1 Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showArmoregg1Image" src="{{ (!empty($digimon02Edit->armoregg1_img)) ? url('Images/Digimon_02/'.$digimon02Edit->armoregg1_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="armoregg2_name" value="{{ $digimon02Edit->armoregg2_name }}" placeholder="Armor Egg 2 Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showArmoregg2Image" src="{{ (!empty($digimon02Edit->armoregg2_img)) ? url('Images/Digimon_02/'.$digimon02Edit->armoregg2_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="baby_evo_name" value="{{ $digimon02Edit->baby_evo_name }}" placeholder="Baby Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showBabyEvoImage" src="{{ (!empty($digimon02Edit->baby_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->baby_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="child_evo_name" value="{{ $digimon02Edit->child_evo_name }}" placeholder="Child Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showChildEvoImage" src="{{ (!empty($digimon02Edit->child_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->child_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="adult_evo_name" value="{{ $digimon02Edit->adult_evo_name }}" placeholder="Adult Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showAdultEvoImage" src="{{ (!empty($digimon02Edit->adult_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->adult_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="armor1_evo_name" value="{{ $digimon02Edit->armor1_evo_name }}" placeholder="Armor 1 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showArmor1EvoImage" src="{{ (!empty($digimon02Edit->armor1_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->armor1_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="armor2_evo_name" value="{{ $digimon02Edit->armor2_evo_name }}" placeholder="Armor 2 Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showArmor2EvoImage" src="{{ (!empty($digimon02Edit->armor2_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->armor2_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="dna_evo_name" value="{{ $digimon02Edit->dna_evo_name }}" placeholder="Dna Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDnaEvoImage" src="{{ (!empty($digimon02Edit->dna_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->dna_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="dnaperfect_evo_name" value="{{ $digimon02Edit->dnaperfect_evo_name }}" placeholder="Dna Perfect Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDnaPerfectEvoImage" src="{{ (!empty($digimon02Edit->dnaperfect_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->dnaperfect_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="dnaultimate_evo_name" value="{{ $digimon02Edit->dnaultimate_evo_name }}" placeholder="Dna Ultimate Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDnaUltimateEvoImage" src="{{ (!empty($digimon02Edit->dnaultimate_evo_img)) ? url('Images/Digimon_02/'.$digimon02Edit->dnaultimate_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
