...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimonfrontier.update') }}" class="forms-sample" enctype="multipart/form-data">
                  @csrf

                  <input type="hidden" name="id" value="{{ $digimonfrontierEdit->id }}">

                    <!--Character Preview-->
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="character_name" value="{{ $digimonfrontierEdit->character_name }}" placeholder="Character Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showCharacterImage" src="{{ (!empty($digimonfrontierEdit->character_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->character_img) : url('Images/admin.png') }}" width="150" height="250" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digivise_name" value="{{ $digimonfrontierEdit->digivise_name }}" placeholder="Digivise Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDigiviseImage" src="{{ (!empty($digimonfrontierEdit->digivise_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->digivise_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="spirit_name" value="{{ $digimonfrontierEdit->spirit_name }}" placeholder="Spirit Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showSpiritImage" src="{{ (!empty($digimonfrontierEdit->spirit_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->spirit_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="human_evo_name" value="{{ $digimonfrontierEdit->human_evo_name }}" placeholder="Human Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showHumanEvoImage" src="{{ (!empty($digimonfrontierEdit->human_evo_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->human_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="adult_evo_name" value="{{ $digimonfrontierEdit->adult_evo_name }}" placeholder="Adult Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showAdultEvoImage" src="{{ (!empty($digimonfrontierEdit->adult_evo_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->adult_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="perfect_evo_name" value="{{ $digimonfrontierEdit->perfect_evo_name }}" placeholder="Perfect Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showPerfectEvoImage" src="{{ (!empty($digimonfrontierEdit->perfect_evo_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->perfect_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="fusion_evo_name" value="{{ $digimonfrontierEdit->fusion_evo_name }}" placeholder="Fusion Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showFusionEvoImage" src="{{ (!empty($digimonfrontierEdit->fusion_evo_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->fusion_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="ultimate_evo_name" value="{{ $digimonfrontierEdit->ultimate_evo_name }}" placeholder="Ultimate Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showUltimateEvoImage" src="{{ (!empty($digimonfrontierEdit->ultimate_evo_img)) ? url('Images/Digimon_Frontier/'.$digimonfrontierEdit->ultimate_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
