...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimonsavers.store') }}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digivise1_name" placeholder="Digivise 1 Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDigivise1Image" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digivise2_name" placeholder="Digivise 2 Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDigivise2Image" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="ultimateburst_evo_name" placeholder="Ultimate Burst Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showUltimateBurstEvoImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
