...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimon.store') }}" class="forms-sample" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="creast_name" placeholder="Creast Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showCreastImage" src="{{ url('Images/digitama.png') }}" width="150" height="150" class="mb-2">
