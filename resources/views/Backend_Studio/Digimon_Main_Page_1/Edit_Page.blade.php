...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('digimon.update') }}" class="forms-sample" enctype="multipart/form-data">
                  @csrf

                  <input type="hidden" name="id" value="{{ $digimonEdit->id }}">

                    <!--Character Preview-->
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="character_name" value="{{ $digimonEdit->character_name }}" placeholder="Character Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showCharacterImage" src="{{ (!empty($digimonEdit->character_img)) ? url('Images/Digimon/'.$digimonEdit->character_img) : url('Images/admin.png') }}" width="150" height="250" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="digivise_name" value="{{ $digimonEdit->digivise_name }}" placeholder="Digivise Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showDigiviseImage" src="{{ (!empty($digimonEdit->digivise_img)) ? url('Images/Digimon/'.$digimonEdit->digivise_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="creast_name" value="{{ $digimonEdit->creast_name }}" placeholder="Creast Name">
                                @if($errors->has('creast_name'))
                                    <span class="text-danger">{{ $errors->first('creast_name') }}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showCreastImage" src="{{ (!empty($digimonEdit->creast_img)) ? url('Images/Digimon/'.$digimonEdit->creast_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                                <input type="file" class="form-control-file" id="creast_img" name="creast_img">
                                @if($errors->has('creast_img'))
                                    <span class="text-danger">{{ $errors->first('creast_img') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="baby_evo_name" value="{{ $digimonEdit->baby_evo_name }}" placeholder="Baby Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showBabyEvoImage" src="{{ (!empty($digimonEdit->baby_evo_img)) ? url('Images/Digimon/'.$digimonEdit->baby_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="child_evo_name" value="{{ $digimonEdit->child_evo_name }}" placeholder="Child Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showChildEvoImage" src="{{ (!empty($digimonEdit->child_evo_img)) ? url('Images/Digimon/'.$digimonEdit->child_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="adult_evo_name" value="{{ $digimonEdit->adult_evo_name }}" placeholder="Adult Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showAdultEvoImage" src="{{ (!empty($digimonEdit->adult_evo_img)) ? url('Images/Digimon/'.$digimonEdit->adult_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="perfect_evo_name" value="{{ $digimonEdit->perfect_evo_name }}" placeholder="Perfect Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showPerfectEvoImage" src="{{ (!empty($digimonEdit->perfect_evo_img)) ? url('Images/Digimon/'.$digimonEdit->perfect_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" name="ultimate_evo_name" value="{{ $digimonEdit->ultimate_evo_name }}" placeholder="Ultimate Evolution Name">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <img id="showUltimateEvoImage" src="{{ (!empty($digimonEdit->ultimate_evo_img)) ? url('Images/Digimon/'.$digimonEdit->ultimate_evo_img) : url('Images/admin.png') }}" width="150" height="150" class="mb-2">
...
<script type="text/javascript">
    ...
    // Creast Image Preview
    $('#creast_img').change(function(e){
            var reader = new FileReader();
            reader.onload = function(e){
                $('#showCreastImage').attr('src', e.target.result);
            }
            reader.readAsDataURL(e.target.files[0]);
        });
