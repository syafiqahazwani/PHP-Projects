            ...
            <div class="col-sm-12 col-md-6 col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <br>
                        <br>
            <form method="POST" action="{{ route('food.store') }}" class="forms-sample" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="custom-file">
                        <img id="showImage" src="{{ url('images/admin.png') }}" alt="food_image" width="100"
                        height="100">
                    </div>
                    <br>
                    <br>
