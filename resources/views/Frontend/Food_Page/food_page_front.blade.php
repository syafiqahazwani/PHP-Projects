                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="{{ route('food.main') }}">Home</a>
                                <span>Food Page</span>
                            </div>
                        </div>

                        @foreach($foodMain as $key => $item)

                        <div class="categories__list__post__item">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__pic set-bg">
                                    <img src="{{ (!empty($item->food_image)) ? url('Images/Food_Page/'.$item->food_image) : url('Images/admin.png') }}"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="categories__pagination">
                                    {{ $foodMain->links('pagination::simple-tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
