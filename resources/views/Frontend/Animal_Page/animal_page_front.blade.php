                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="{{ route('animal.main') }}">Home</a>
                                <span>Animal Page</span>
                            </div>
                        </div>

                        @foreach($animalMain as $key => $item)

                        <div class="categories__list__post__item">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__pic set-bg">
                                    <img src="{{ (!empty($item->animal_image)) ? url('Images/Animal_Page/'.$item->animal_image) : url('Images/admin.png') }}"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__text">
                                        ...
                                        <ul class="post__widget">
                                            ...
                                            <li>{{ $item->animal_which_country }}</li>
                                        </ul>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                {{ $animalMain->links('pagination::simple-tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
