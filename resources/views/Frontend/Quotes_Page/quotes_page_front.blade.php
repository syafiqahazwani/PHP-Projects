                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="{{ route('quotes.main') }}">Home</a>
                                <span>Quotes Page</span>
                            </div>
                        </div>

                        @foreach($quotesMain as $key => $item)

                        <div class="categories__list__post__item">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__pic set-bg">
                                    <img src="{{ (!empty($item->quotes_image)) ? url('Images/Quotes_Page/'.$item->quotes_image) : url('Images/admin.png') }}"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__text">
                                        ...
                                        <h3>{{ $item->quotes_description }}</h3>
                                        <ul class="post__widget">
                                            <li>by <span>Admin</span></li>
                                            <li>{{ $item->created_at }}</li>
                                            <li></li>
                                        </ul>
                                        <p>Motivational Quotes {{ $key+1 }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="categories__pagination">
                                    {{ $quotesMain->links('pagination::simple-tailwind') }}
                                </div>
                            </div>
                        </div>
                    </div>
