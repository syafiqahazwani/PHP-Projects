...
<head>
  ...
  <link rel="icon" href="{{asset('AdminLTE-master')}}/dist/img/Logo L (1).png">
...
<!-- Preloader -->
  ...
  <img class="animation__shake" src="{{asset('AdminLTE-master')}}/dist/img/logo.png" alt=""  width="800" height="500" class="" style="opacity: .8"></div>
  </div>