    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">   
                    <a href="{{ route('login') }}" class="btn btn-secondary btn-block mb-4">
					<i class="fas fa-angle-right"></i>&nbsp;&nbsp;&nbsp;Login</a>
 
                    <a href="{{ route('register') }}" class="btn btn-secondary btn-block mb-4">
                    <i class="fas fa-angle-right"></i>&nbsp;&nbsp;&nbsp;Sign Up</a>      
                </div>
        </div>

        <img src="{{asset('Backend')}}/dist/assets/images/digitama.png" alt="Centered Image" width="200">
