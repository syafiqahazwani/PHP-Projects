    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h6 class="card-title">Quotes Image :</h6>
                    ...
                    <div class="custom-file">
                        <img id="showImage" src="<?php echo e(url('images/admin.png')); ?>"
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/Quotes_Page/quotes_page.blade.php ENDPATH**/ ?>