        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Mydatabase Create</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12 ">
        <div class="card card-absolute shadow b-dark border-1 wow slideInUp">
          <div class="card-header bg-gray">
           <h5 class="text-white"><b>Add New Information Database</b></h5>
      </div>
      <div class="container-fluid">
      <div class="row">  
      </div>
...
<form method="post" action="<?php echo e(route('mydatabase.store')); ?>" enctypr="multipart/form-data">
<?php echo csrf_field(); ?>
...
<div class="form-group">
  <label class="col-md-12 control-label" >Folder Name:</label> 
    ...
    <div class="input-group">
  <input type="text" name="FolderName" placeholder="Insert Fail Name" class="form-control">
    </div>
...
<div class="form-group">
  <label class="col-md-12 control-label">Folder Information:</label>
    <div class="col-md-12 inputGroupContainer">
    <div class="input-group">
      <textarea class="form-control" name="FolderInformation" placeholder="Insert Folder Information"></textarea>
  </div>
...
<!-- Insert PDF -->
 ...
 <div class="col-md-6 inputGroupContainer">
  <input class="form-control" type="file" name="InsertPDF" id="formFile">
...
<div class="form-group">
  ...
  <div class="col-md-6">
    <button type="submit" class="btn btn-primary" >Submit Folder<span class="glyphicon glyphicon-send"></span></button>
  </div>
</div>
</form>
</div>
...
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/mydatabase/create.blade.php ENDPATH**/ ?>