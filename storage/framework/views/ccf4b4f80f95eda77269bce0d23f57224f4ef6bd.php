        ...
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <div class="header__btn">
                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="primary-btn">DASHBOARD</a>
                </div>
            </div>
...
<!-- Header Section End -->
<?php /**PATH C:\xampp\htdocs\Exploredia_Web\resources\views/Frontend/Body/header_front.blade.php ENDPATH**/ ?>