            ...
            <div class="sticky-top mb-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">A Day Event</h4>
                </div>
                <div class="card-body">
                  <!-- the events -->
                  <div id="external-events">
                    <div class="external-event bg-success">Success Day</div>
                    <div class="external-event bg-warning">Warning Day</div>
                    <div class="external-event bg-info">Info Day</div>
                    <div class="external-event bg-danger">Danger Day</div>
                    <div class="checkbox">
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\resources\views/Information/calendar.blade.php ENDPATH**/ ?>