...
<?php $__env->stopSection(); ?>
                    ...
                    <div class="d-flex align-items-center">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb m-0 p-0">
                                <li class="breadcrumb-item"><a href="index.html" class="text-muted">City Page</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="<?php echo e(route('city.add')); ?>" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-plane"></i>&nbsp;  Add On City</a>
                </div>
            </div>
            <br>
            <br>
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/City_Page/main_page_city.blade.php ENDPATH**/ ?>