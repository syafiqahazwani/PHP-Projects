<!-- Sidebar -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img src="<?php echo e(asset('AdminLTE-master')); ?>/dist/img/Logo L (2).png" alt="logo-wrapper text-center vertical-center" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <?php if(auth()->guard()->check()): ?>
        <div class="info">
          <a href="" class="d-block"><b>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e(auth()->user()->name); ?></b></a>
        </div>
      </div>
      <?php endif; ?>
        ...
        <li class="nav-header">OTHERS</li>
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('/calendar')); ?>" class="nav-link">
                  <i class=""></i>
                  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CALENDAR</p>
                </a>
              </li>
...
<li class="nav-header">END</li>
  ...
  <!-- Side Menu End -->
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>