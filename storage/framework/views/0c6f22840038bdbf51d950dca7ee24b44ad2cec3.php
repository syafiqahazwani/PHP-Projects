                ...
                <div class="col-sm-12 col-md-6 col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <br>
                            <br>
                    <form method="POST" action="<?php echo e(route('city.update')); ?>" class="forms-sample" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>

                        <input type="hidden" name="id" value="<?php echo e($cityEdit->id); ?>">
                    ...
                    <div class="custom-file">
                        <img id="showImage" src="<?php echo e((!empty($cityEdit->city_image)) ? url('Images/City_Page/'.$cityEdit->city_image) : url('Images/admin.png')); ?>"
                    ...
                    <br>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city_name" value="<?php echo e($cityEdit->city_name); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="city_which_country" value="<?php echo e($cityEdit->city_which_country); ?>"
                        ...
                        <br>
                            ...
                            <div class="form-group">
                                ...
                                value="<?php echo e($cityEdit->city_description); ?>"><?php echo e($cityEdit->city_description); ?></textarea>
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Exploredia_Web\resources\views/Backend/City_Page/edit_page.blade.php ENDPATH**/ ?>