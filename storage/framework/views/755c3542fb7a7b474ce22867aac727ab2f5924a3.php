        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Japanese Create</li> 
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12 ">
        <div class="card card-absolute shadow b-dark border-1 wow slideInUp">
          <div class="card-header bg-success">
           <h5 class="text-white"><b>Create New Japanese Database</b></h5>
      </div>
      <div class="container-fluid">
      <div class="row">
      </div>
...
<div class="form-group">
  ...
  <input type="text" placeholder="Insert Title" class="form-control" name="JapaneseName" id="formGroupExampleInput">
    </div>
...
<div class="form-group">
  <label class="col-md-12 control-label">Main Character/Cast:</label>
    ...
    <div class="input-group">
      ...
      <textarea class="form-control" input type="text" name="JapaneseMainCharacter" placeholder="Insert Main Character/Cast" id="formGroupExampleInput1" ></textarea>
  </div>
...
<div class="form-group">
    <label class="col-md-4 control-label">Episode/Movie</label>
      ...
      <div class="radio">
        <label>
      <input type="radio" name="EpisodeMovie" id="flexRadioDefault1" value="Episode" /> Episode
        </label>
      </div>
      <div class="radio">
        <label>
      <input type="radio" name="EpisodeMovie" id="flexRadioDefault2" value="Movie" /> Movie
        </label>
    </div>
    <div class="radio">
        <label>
      <input type="radio" name="EpisodeMovie" id="flexRadioDefault1" value="Both" /> Both Episode/Movie
        </label>
      </div>
...
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/Japanese/create.blade.php ENDPATH**/ ?>