        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Korea Create</li> 
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="col-sm-12 ">
        <div class="card card-absolute shadow b-dark border-1 wow slideInUp">
          <div class="card-header bg-warning">
           <h5 class="text-white"><b>Create New Korea Database</b></h5>
      </div>
      <div class="container-fluid">
      <div class="row">
      </div>
...
<form method="post" action="<?php echo e(route('korea.store')); ?>" enctypr="multipart/form-data">
<?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/korea/create.blade.php ENDPATH**/ ?>