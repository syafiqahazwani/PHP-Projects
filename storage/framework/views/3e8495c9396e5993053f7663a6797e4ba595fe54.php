...
<div class="wrapper"> 
  ...
  <img class="animation__shake" src="<?php echo e(asset('AdminLTE-master')); ?>/dist/img/logo.png" alt=""  width="900" height="900" class="" style="opacity: .8"></div>
  </div>

 <?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/auth/header.blade.php ENDPATH**/ ?>