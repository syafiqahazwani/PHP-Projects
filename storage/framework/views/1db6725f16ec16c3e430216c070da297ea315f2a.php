                ...
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item"><a href="index.html" class="text-muted">Work Page</a></li>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="<?php echo e(route('work.add')); ?>" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-laptop"></i>&nbsp;  Add On Work</a>
                </div>
            </div>
            <br>
            <br>
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/Work_Page/main_page_work.blade.php ENDPATH**/ ?>