        ...
        <table id="example1" class="table table-striped table-bordered no-wrap">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><img src="url('Images/City_Page/'.$item->city_image)"
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/City_Page/city_page.blade.php ENDPATH**/ ?>