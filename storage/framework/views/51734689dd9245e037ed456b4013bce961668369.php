                ...
                <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-lg-12 text-center mt-5">
                            Don't have an account? <a href="<?php echo e(route('register')); ?>" class="text-danger">Sign Up</a>
                        </div>
                    </div>
                </form>
...
<?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/auth/login.blade.php ENDPATH**/ ?>