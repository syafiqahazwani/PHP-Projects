...
<head>
  ...
  <link rel="icon" href="<?php echo e(asset('AdminLTE-master')); ?>/dist/img/Logo L (1).png">
  <title>Laravel Asterisk</title>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('AdminLTE-master')); ?>/plugins/summernote/summernote-bs4.min.css">
...
<div class="wrapper"> 
  ...
  <img class="animation__shake" src="<?php echo e(asset('AdminLTE-master')); ?>/dist/img/logo.png" alt=""  width="800" height="500" class="" style="opacity: .8"></div>
  </div>

 

<?php /**PATH C:\Laravel\htdocs\Laravel_Asterisk\resources\views/layouts/header.blade.php ENDPATH**/ ?>