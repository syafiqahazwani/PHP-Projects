    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                <a href="<?php echo e(route('quotes.add')); ?>" class="btn waves-effect waves-light btn-rounded btn-primary"><i class="fas fa-chess-queen"></i>&nbsp;  Add On Quotes</a>
                </div>
            </div>
            <br>
            <br>
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/Quotes_Page/main_page.blade.php ENDPATH**/ ?>