          ...
          <th class="text-center" width="8%">Action</th>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $korea): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <td class="text-center"> <?php echo e($korea->id); ?> </td>
                   ...
                   <a class="btn btn-warning btn-sm" data-bs-toggle="modal" title="View Korea" href="<?php echo e(route('korea.show', ['korea' => $korea])); ?>">
                          <i class="fas fa-eye"> 
                          </i>
                    </a>

                    <a class="btn btn-info btn-sm" data-bs-toggle="modal" title="Edit Korea" href="<?php echo e(route('korea.edit', ['korea' => $korea])); ?>">
                           <i class="fas fa-edit">
                          </i>
                      </a>

<!-- Delete Button trigger modal -->
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalKorea<?php echo e($korea->id); ?>"><i class="fas fa-trash" aria-hidden="true"></i>
</button>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/Korea/movie_drama.blade.php ENDPATH**/ ?>