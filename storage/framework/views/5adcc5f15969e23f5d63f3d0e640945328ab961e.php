...
<nav class="main-header navbar navbar-expand navbar-dark">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo e(url('/dashboard')); ?>" class="nav-link">Home/Latest News</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
...
<!-- End User Login & Register -->
  ...
  <!-- End Navbar -->
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>