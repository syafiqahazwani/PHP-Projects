            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $anime): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                   ...
                   <td class="text-center">
                          ...
                          <a class="btn btn-warning btn-sm" data-bs-toggle="modal" title="View Anime" href="<?php echo e(route('anime.show', ['anime' => $anime])); ?>">
                              <i class="fas fa-eye"> 
                              </i>
                          </a>

                          <a class="btn btn-info btn-sm" data-bs-toggle="modal" title="Edit Anime" href="<?php echo e(route('anime.edit', ['anime' => $anime])); ?>">
                              <i class="fas fa-edit">
                              </i>
                          </a> 

<!-- Delete Button trigger modal -->
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalAnime<?php echo e($anime->id); ?>"><i class="fas fa-trash" aria-hidden="true"></i>
</button>
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/Anime/anime_watched.blade.php ENDPATH**/ ?>