          ...
          <th class="text-center" width="8%">Action</th>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $japanese): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <td class="text-center"> <?php echo e($japanese->id); ?> </td>
                   ...
                   <a class="btn btn-warning btn-sm" data-bs-toggle="modal" title="View Japanese" href="<?php echo e(route('japanese.show', ['japanese' => $japanese])); ?>">
                          <i class="fas fa-eye"> 
                          </i>
                    </a>

                    <a class="btn btn-info btn-sm" data-bs-toggle="modal" title="Edit Japanese" href="<?php echo e(route('japanese.edit', ['japanese' => $japanese])); ?>">
                           <i class="fas fa-edit">
                          </i>
                      </a>

<!-- Delete Button trigger modal -->
<button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#exampleModalJapan<?php echo e($japanese->id); ?>"><i class="fas fa-trash" aria-hidden="true"></i>
</button>
...
<?php /**PATH C:\xampp\htdocs\Laravel_Asterisk\Laravel_Asterisk\resources\views/Japanese/movie_drama.blade.php ENDPATH**/ ?>