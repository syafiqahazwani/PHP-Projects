            ...
            <div class="col-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <!-- Card -->
                        <div class="card">
                            <img class="card-img-top img-fluid" src="<?php echo e(asset('Frontend')); ?>/img/categories/Quotes.png" width="150"
                            height="150" alt="quotes">
                            <div class="card-body">
                                <h4 class="card-title">Quotes Page</h4>
                                <p class="card-text">Daily personal motivation Quotes</p>
                                <a href="<?php echo e(route('quotes.page')); ?>" class="btn btn-success"><i class="fas fa-chess-queen"></i></a>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <!-- Card -->
                        <div class="card">
                            <img class="card-img-top img-fluid" src="<?php echo e(asset('Frontend')); ?>/img/categories/kuala_lumpur.jpg" width="150"
                            height="150" alt="city">
                            <div class="card-body">
                                <h4 class="card-title">City Page</h4>
                                <p class="card-text">Dream place to travel around the world</p>
                                <a href="<?php echo e(route('city.page')); ?>" class="btn btn-danger"><i class="fas fa-plane"></i></a>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <!-- Card -->
                        <div class="card">
                            <img class="card-img-top img-fluid" src="<?php echo e(asset('Frontend')); ?>/img/categories/nasi_lemak.jpg" width="150"
                            height="150" alt="food">
                            <div class="card-body">
                                <h4 class="card-title">Food Page</h4>
                                <p class="card-text">Best delicious Food around the world</p>
                                <a href="<?php echo e(route('food.page')); ?>" class="btn btn-warning"><i class="fas fa-utensils"></i></a>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 img-fluid">
                        <!-- Card -->
                        <div class="card">
                            <img class="card-img-top img-fluid" src="<?php echo e(asset('Frontend')); ?>/img/categories/tiger.webp" width="150"
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo e(route('animal.page')); ?>" class="btn btn-secondary"><i class="fas fa-paw"></i></a>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
...
<?php echo $__env->make('Backend.Body.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Backend/Admin/dashboard_page.blade.php ENDPATH**/ ?>