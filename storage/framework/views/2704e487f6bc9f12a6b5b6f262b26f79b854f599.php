                    ...
                    <div class="col-lg-8 col-md-8">
                        <div class="breadcrumb__text">
                            ...
                            <div class="breadcrumb__option">
                                <a href="<?php echo e(route('city.main')); ?>">Home</a>
                                <span>City Page</span>
                            </div>
                        </div>

                        <?php $__currentLoopData = $cityMain; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                        <div class="categories__list__post__item">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__pic set-bg">
                                    <img src="<?php echo e((!empty($item->city_image)) ? url('Images/City_Page/'.$item->city_image) : url('Images/admin.png')); ?>"
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="categories__post__item__text">
                                        ...
                                        <h3><?php echo e($item->city_name); ?></h3>
                                        <ul class="post__widget">
                                            <li>by <span>Admin</span></li>
                                            <li><?php echo e($item->created_at); ?></li>
                                            <li><?php echo e($item->city_which_country); ?></li>
                                        </ul>
                                        <p><?php echo e($item->city_description); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="categories__pagination">
                                    <?php echo e($cityMain->links('pagination::simple-tailwind')); ?>
...
<?php echo $__env->make('Frontend.Body.master_front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Laravel\htdocs\Exploredia_Web\resources\views/Frontend/City_Page/city_page_front.blade.php ENDPATH**/ ?>